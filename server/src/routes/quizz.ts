...
router.get(
  "/for-user/:id",
  quizzValidator.getQuizzById,
  quizzController.getQuizzForUserAnswer
);
router.get(
  "/one/:id",
  quizzValidator.getQuizzById,
...
router.put(
  "/update/:id",
  quizzValidator.updateQuizzById,
  quizzController.updateQuizzById
);
router.delete(
  "/delete/:id",
  quizzValidator.getQuizzById,
  quizzController.deleteQuizzById
);
